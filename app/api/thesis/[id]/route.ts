...
import { handleError, successResponse, errorResponse } from "@/lib/api-utils";
...
export async function GET(
  ...
  try {
    ...
    if (rows.length === 0) {
      return errorResponse("Data skripsi tidak ditemukan", 404);
    }
    ...
    const formattedData: Thesis = {
      ...
      // Handle parsing jika DB mengembalikan string JSON
