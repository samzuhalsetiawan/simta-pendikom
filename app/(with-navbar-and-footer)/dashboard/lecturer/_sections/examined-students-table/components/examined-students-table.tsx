...
interface ExaminedStudentsTableProps {
  studentsThesis: Thesis[];
}

export function ExaminedStudentsTable({
  studentsThesis,
}: ExaminedStudentsTableProps) {
  ...
  const sortedStudentsThesis = useMemo(() => {
    return [...studentsThesis].sort((a, b) => {
      switch (sortOption) {
        ...
        case "upcomingAgenda":
          return 0; // Placeholder, as upcoming agenda data is not available
      }
    });
            ...
            {sortedStudentsThesis.map((studentThesis) => (
              ...
              >
                ...
                <TableCell className="text-right text-sm">
                  {"-" /* Placeholder for upcoming agenda */}
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
