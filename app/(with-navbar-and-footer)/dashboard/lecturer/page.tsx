...
import { ImportantSection, NotificationItem } from "@/app/(with-navbar-and-footer)/dashboard/_components/important-section";
import { MentoringTable, Student } from "@/app/(with-navbar-and-footer)/dashboard/_components/mentoring-table";
import { ExamTable, ExamStudent } from "@/app/(with-navbar-and-footer)/dashboard/_components/exam-table";
import { EventCalendar, CalendarEvent } from "@/app/(with-navbar-and-footer)/dashboard/_components/event-calendar/event-calendar";
